<?php
	...
	/*function createUser($fname, $username, $password, $email, $lvllist) {
	  ...
	  $userString = "INSERT INTO tbl_user(`user_fname`,`user_name`, `user_pass`,`user_email`, `user_ip`, `user_status`, `user_login_count`, `user_verified`) VALUES('{$fname}', '{$username}', '{$password}', '{$email}', 'no', '{$userlvl}', '{$count}', '{$verified}')"; //Removed Date since currentstamp
